...
public class CreateQRcode {
	public static void main(String[] args) throws IOException {
		...
		BufferedImage logo=ImageIO.read(new File("D:/ZHIFUBAO.jpg"));
		int zhifubaoSize=imageSize/4;
		int o=(imageSize-zhifubaoSize)/2;
		gs.drawImage(logo, o, o, zhifubaoSize, zhifubaoSize,null);
		gs.dispose();
		bufferedImage.flush();
		try{
